		...
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
			<div className="bg-vscode-input-background border border-vscode-dropdown-border rounded-lg p-6 w-96 max-w-full mx-4 relative">
				...
				<div className="space-y-4">
					...
					<div className="text-xs text-muted-foreground text-center">Supported formats: .yaml, .yml</div>

					{/* Actions */}
					<div className="flex gap-2 pt-2">
						<Button variant="ghost" size="sm" onClick={onClose} disabled={isUploading} className="flex-1">
							Cancel
						</Button>
					</div>
				</div>
