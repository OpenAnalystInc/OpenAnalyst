...
import { MessageSquare, BarChart3, FileText, Settings, CheckCircle2, Loader2 } from "lucide-react"
	...
	return (
		<div
			...
			<div className="flex items-start gap-3">
				{/* Category Icon */}
				<div className={cn("flex-shrink-0 p-2 rounded", categoryColors.bg, categoryColors.border)}>
					...
					<div className="flex items-center gap-2 mt-1">
						...
						{conflictInfo && !isActive && (
							<span
								...
								title={`Will replace ${conflictInfo.existingBlock.block.name}`}>
								Will replace
							</span>
						)}
					</div>
