...
import { Check, Settings, ExternalLink, AlertCircle, Loader2, ChevronRight } from "lucide-react"
		...
		<div className="px-3 py-2 border-b border-vscode-dropdown-border last:border-b-0">
			...
			<div className="flex items-center justify-between mb-2">
				<div className="flex items-center gap-2">
					{getStatusIcon()}
					<div>
						<div className="font-medium text-sm text-vscode-foreground">{data.name}</div>
						{defaultModel && (
 ...
 */
export const ModelsPopover: React.FC<ModelsPopoverProps> = ({ onModelSelect, onModelSetup, className }) => {
	// ============================
	// State Management
	// ============================
			...
			<PopoverContent
				...
				<div className="px-3 py-2 border-b border-vscode-dropdown-border">
					<div className="flex items-center justify-between">
						<h3 className="font-medium text-sm text-vscode-foreground">Models</h3>
						<button
							onClick={handleClose}
				...
				<div className="px-3 py-2 border-t border-vscode-dropdown-border">
					<div className="flex items-center justify-between text-xs text-vscode-descriptionForeground">
						...
						<span>
							{Object.values(mockModelsData.categories).reduce(
								(acc, cat) => acc + cat.models.filter((m) => m.isSetup).length,
								0,
							)}{" "}
							configured
						</span>
