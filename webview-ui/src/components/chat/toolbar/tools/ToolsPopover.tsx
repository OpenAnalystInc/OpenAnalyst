			...
			<PopoverContent
				...
				<div className="px-4 pt-2 border-b border-vscode-dropdown-border">
					<div className="flex items-center justify-between">
						<h3 className="font-medium text-sm text-vscode-foreground">Development Tools</h3>
						<button
							onClick={handleClose}
				...
				<div className="px-4 py-3 border-t border-vscode-dropdown-border mt-2">
					...
					<div className="flex items-center gap-2 mb-2">
						<Button variant="secondary" size="sm" onClick={onManageTools} className="flex-1 h-8 text-xs">
							<Settings className="w-3 h-3 mr-1" />
							Manage Tools
						</Button>

						<Button variant="ghost" size="sm" onClick={handleClose} className="flex-1 h-8 text-xs">
					...
					<div className="flex items-center justify-between text-xs text-vscode-descriptionForeground">
						<div className="flex items-center gap-3">
							<span>
								{filteredTools.length} of {toolStats.total} tools
							</span>
						...
						<span>{toolStats.enabled} enabled</span>
					</div>
				</div>
			</PopoverContent>
		</Popover>
