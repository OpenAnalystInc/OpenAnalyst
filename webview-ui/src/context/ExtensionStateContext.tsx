...
import { McpMarketplaceCatalog } from "../../../src/shared/oacode/mcp" // oacode_change

import { vscode } from "@src/utils/vscode"
import { convertTextMateToHljs } from "@src/utils/textMateToHljs"
import { ClineRulesToggles } from "@roo/cline-rules" // oacode_change

export interface ExtensionStateContextType extends ExtensionState {
	historyPreviewCollapsed?: boolean // Add the new state property
	showTaskTimeline?: boolean // oacode_change
	setShowTaskTimeline: (value: boolean) => void // oacode_change
	hoveringTaskTimeline?: boolean // oacode_change
	setHoveringTaskTimeline: (value: boolean) => void // oacode_change
	systemNotificationsEnabled?: boolean // oacode_change
	setSystemNotificationsEnabled: (value: boolean) => void // oacode_change
	dismissedNotificationIds: string[] // oacode_change
	didHydrateState: boolean
	showWelcome: boolean
	theme: any
	mcpServers: McpServer[]
	mcpMarketplaceCatalog: McpMarketplaceCatalog // oacode_change
	...
	allowVeryLargeReads?: boolean // oacode_change
	...
	setShowAutoApproveMenu: (value: boolean) => void // oacode_change
	...
	commitMessageApiConfigId?: string // oacode_change
	setCommitMessageApiConfigId: (value: string) => void // oacode_change
	markNotificationAsDismissed: (notificationId: string) => void // oacode_change
	ghostServiceSettings?: GhostServiceSettings // oacode_change
	setGhostServiceSettings: (value: GhostServiceSettings) => void // oacode_change
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState & { organizationAllowList?: OrganizationAllowList }>({
		...
		alwaysAllowWrite: true, // oacode_change
		alwaysAllowReadOnly: true, // oacode_change
		...
		showAutoApproveMenu: false, // oacode_change
		...
		allowVeryLargeReads: false, // oacode_change
		terminalZshP10k: false, // Default Powerlevel10k integration setting
		terminalZdotdir: false, // Default ZDOTDIR handling setting
		terminalCompressProgressBar: true, // Default to compress progress bar output
		historyPreviewCollapsed: false, // Initialize the new state (default to expanded)
		showTaskTimeline: true, // oacode_change
		cloudUserInfo: null,
	...
	const [mcpMarketplaceCatalog, setMcpMarketplaceCatalog] = useState<McpMarketplaceCatalog>({ items: [] }) // oacode_change
	...
	const contextValue: ExtensionStateContextType = {
		...
		theme,
		mcpServers,
		mcpMarketplaceCatalog, // oacode_change
		currentCheckpoint,
		filePaths,
		openedTabs,
		// oacode_change start
		...
		dismissedNotificationIds: state.dismissedNotificationIds || [], // oacode_change
		// oacode_change end
