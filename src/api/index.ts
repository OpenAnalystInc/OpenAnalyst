...
import {
	...
	OpenAiHandler,
	// OllamaHandler, // oacode_change
	LmStudioHandler,
	GeminiHandler,
	GeminiCliHandler, // oacode_change
	OpenAiNativeHandler,
	DeepSeekHandler,
	MoonshotHandler,
	MistralHandler,
	...
	FakeAIHandler,
	XAIHandler,
	BigModelHandler, // oacode_change
	GroqHandler,
	HuggingFaceHandler,
	ChutesHandler,
	LiteLLMHandler,
	VirtualQuotaFallbackHandler, // oacode_change
	ClaudeCodeHandler,
	SambaNovaHandler,
	DoubaoHandler,
	ZAiHandler,
...
export function buildApiHandler(configuration: ProviderSettings): ApiHandler {
	...
	switch (apiProvider) {
		case "oacode":
			return new OacodeOpenrouterHandler(options)
		case "anthropic":
