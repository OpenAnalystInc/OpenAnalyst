...
export interface ExtensionMessage {
	type:
		...
		| "mcpDownloadDetails" // oacode_change
		| "showSystemNotification" // oacode_change
		| "openInBrowser" // oacode_change
		| "acceptInput"
		...
		| "oacodeNotificationsResponse" // oacode_change
	...
	mcpDownloadDetails?: McpDownloadResponse // oacode_change
	notificationOptions?: {
		title?: string
		subtitle?: string
		message: string
	} // oacode_change
	url?: string // oacode_change
	setting?: string
	value?: any
	...
	fixedCode?: string | null // For mermaidFixResponse // oacode_change
	errors?: string[]
	...
	messageTs?: number
	context?: string
	// oacode_change start: Notifications
	notifications?: Array<{
		id: string
		title: string
		message: string
...
export type ExtensionState = Pick<
	...
	| "globalRulesToggles" // oacode_change
	| "localRulesToggles" // oacode_change
...
> & {
	...
	showRooIgnoredFiles: boolean // Whether to show .oacodeignore'd files in listings
	maxReadFileLine: number // Maximum number of lines to read from a file before truncating
	showAutoApproveMenu: boolean // oacode_change: Whether to show the auto-approve menu in the chat view
...
export interface ClineApiReqInfo {
	...
	cacheReads?: number
	cost?: number
	usageMissing?: boolean // oacode_change
