...
import { getEditFileDescription } from "./edit-file" // oacode_change: Morph fast apply
...
const toolDescriptionMap: Record<string, (args: ToolArgs) => string | undefined> = {
	...
	edit_file: () => getEditFileDescription(), // oacode_change: Morph fast apply
	apply_diff: (args) =>
...
export function getToolDescriptionsForMode(
	...
	// oacode_change: Morph fast apply
