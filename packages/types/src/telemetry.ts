...
export const rooCodeTelemetryEventSchema = z.discriminatedUnion("type", [
	z.object({
		type: z.enum([
			// oacode_change start
			TelemetryEventName.COMMIT_MSG_GENERATED, // oacode_change
			TelemetryEventName.INLINE_ASSIST_QUICK_TASK, // oacode_change
			TelemetryEventName.INLINE_ASSIST_AUTO_TASK, // oacode_change
			TelemetryEventName.INLINE_ASSIST_ACCEPT_SUGGESTION, // oacode_change
			TelemetryEventName.INLINE_ASSIST_REJECT_SUGGESTION, // oacode_change
			TelemetryEventName.WEBVIEW_MEMORY_USAGE, // oacode_change
			// oacode_change end
...
export interface TelemetryClient {
	...
	updateIdentity(oacodeToken: string): Promise<void>
	// oacode_change end
