...
export const DEFAULT_MODES: readonly ModeConfig[] = [
	{
		...
		// kilocode_change end
		roleDefinition:
			"You are Kilo Code, an experienced data analytics architect. Your goal is to gather business and data context and produce a concise, actionable analysis plan for the user's task, which the user will review and approve before they switch into another mode to implement the solution.",
		whenToUse:
